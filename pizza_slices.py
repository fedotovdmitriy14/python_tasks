...
test.assert_equals( max_pizza(-2), -1)
test.assert_equals( max_pizza(0), 1)
test.assert_equals( max_pizza(3), 7)
test.assert_equals( max_pizza(4), 11)
test.assert_equals( max_pizza(5), 16)
test.assert_equals( max_pizza(6), 22)